...
architecture behav of Game_logic is 
    ...
    "Game_logic,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.880875,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=2,HLS_SYN_FF=1322,HLS_SYN_LUT=1454,HLS_VERSION=2018_3}";
    ...
    component Game_logic_urem_3cud IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Game_logic_urem_1dEe IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Game_logic_mac_mufYi IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    Game_logic_urem_3cud_U2 : component Game_logic_urem_3cud
    generic map (
        ID => 1,
        NUM_STAGE => 36,
        din0_WIDTH => 32,
    ...
    Game_logic_urem_1dEe_U3 : component Game_logic_urem_1dEe
    generic map (
        ID => 1,
        NUM_STAGE => 15,
        din0_WIDTH => 11,
    ...
    Game_logic_urem_1dEe_U4 : component Game_logic_urem_1dEe
    generic map (
        ID => 1,
        NUM_STAGE => 15,
        din0_WIDTH => 11,
    ...
    Game_logic_mac_mufYi_U6 : component Game_logic_mac_mufYi
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 5,
