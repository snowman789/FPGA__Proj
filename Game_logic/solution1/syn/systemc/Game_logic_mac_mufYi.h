...
// ==============================================================
#ifndef __Game_logic_mac_mufYi__HH__
#define __Game_logic_mac_mufYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Game_logic_mac_mufYi) {
    ...
    SC_CTOR(Game_logic_mac_mufYi):  simcore_mac_1_U ("simcore_mac_1_U") {
