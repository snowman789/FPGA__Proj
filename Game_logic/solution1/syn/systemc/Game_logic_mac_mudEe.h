...
// ==============================================================
#ifndef __Game_logic_mac_mudEe__HH__
#define __Game_logic_mac_mudEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Game_logic_mac_mudEe) {
    ...
    SC_CTOR(Game_logic_mac_mudEe):  simcore_mac_0_U ("simcore_mac_0_U") {
