...
// ==============================================================
#ifndef __Game_logic_urem_3bkb__HH__
#define __Game_logic_urem_3bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Game_logic_urem_3bkb) {
    ...
    SC_CTOR(Game_logic_urem_3bkb):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
