...
// ==============================================================
#ifndef __Game_logic_urem_3cud__HH__
#define __Game_logic_urem_3cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Game_logic_urem_3cud) {
    ...
    SC_CTOR(Game_logic_urem_3cud):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
