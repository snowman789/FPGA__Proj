...
set C_modelArgList {
	...
	{ verify1_out int 1 regular {pointer 1}  }
	{ verify2_out int 1 regular {pointer 1}  }
	{ verify3_out int 1 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "rst", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "rst","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "verify1_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "verify1_out","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "verify2_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "verify2_out","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "verify3_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "verify3_out","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} ]}
...
set portList { 
	...
	{ lose sc_out sc_logic 1 signal 4 } 
	{ time_remaining_out_V sc_out sc_lv 10 signal 5 } 
	{ time_remaining_in_V sc_in sc_lv 10 signal 6 } 
	{ verify1_out sc_out sc_logic 1 signal 7 } 
	{ verify2_out sc_out sc_logic 1 signal 8 } 
	{ verify3_out sc_out sc_logic 1 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "verify1_out", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "verify1_out", "role": "default" }} , 
 	{ "name": "verify2_out", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "verify2_out", "role": "default" }} , 
 	{ "name": "verify3_out", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "verify3_out", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6"],
		...
		"Port" : [
			...
			{"Name" : "verify1_out", "Type" : "None", "Direction" : "O"},
			{"Name" : "verify2_out", "Type" : "None", "Direction" : "O"},
			{"Name" : "verify3_out", "Type" : "None", "Direction" : "O"},
			...
			{"Name" : "slow_down_clock", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "RandSeed", "Type" : "OVld", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Gamelogic2_urem_3bkb_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Gamelogic2_urem_3cud_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Gamelogic2_urem_1dEe_U3", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Gamelogic2_urem_1dEe_U4", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Gamelogic2_mac_mueOg_U5", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Gamelogic2_mac_mufYi_U6", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	Gamelogic2 {
		...
		verify1_out {Type O LastRead -1 FirstWrite 1}
		verify2_out {Type O LastRead -1 FirstWrite 1}
		verify3_out {Type O LastRead -1 FirstWrite 1}
		...
		slow_down_clock {Type IO LastRead -1 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	verify1_out { ap_none {  { verify1_out out_data 1 1 } } }
	verify2_out { ap_none {  { verify2_out out_data 1 1 } } }
	verify3_out { ap_none {  { verify3_out out_data 1 1 } } }
}
