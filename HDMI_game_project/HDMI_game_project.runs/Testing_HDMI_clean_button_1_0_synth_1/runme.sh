...
HD_PWD='D:/FPGA_WORKSPACES/FPGA_Final_Project/FPGA__Proj/HDMI_game_project/HDMI_game_project.runs/Testing_HDMI_clean_button_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Testing_HDMI_clean_button_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Testing_HDMI_clean_button_1_0.tcl
