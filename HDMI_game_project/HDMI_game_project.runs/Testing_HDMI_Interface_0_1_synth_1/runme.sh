...
HD_PWD='C:/Users/itr9fc/Desktop/FPGA__Proj/HDMI_game_project/HDMI_game_project.runs/Testing_HDMI_Interface_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Testing_HDMI_Interface_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Testing_HDMI_Interface_0_1.tcl
