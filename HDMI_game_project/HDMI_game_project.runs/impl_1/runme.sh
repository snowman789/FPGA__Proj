...
HD_PWD='D:/FPGA_WORKSPACES/FPGA_Final_Project/FPGA__Proj/HDMI_game_project/HDMI_game_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Testing_HDMI_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Testing_HDMI_wrapper.tcl -notrace
