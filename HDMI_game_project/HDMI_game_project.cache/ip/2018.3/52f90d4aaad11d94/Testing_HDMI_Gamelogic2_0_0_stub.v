...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst, ap_start, ap_done, ap_idle, 
  ap_ready, btn0, btn1, btn2, btn3, center_line_out_V, center_line_in_V, right_r)
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,btn0,btn1,btn2,btn3,center_line_out_V[9:0],center_line_in_V[9:0],right_r" */;
  input ap_clk;
  input ap_rst;
  input ap_start;
  output ap_done;
