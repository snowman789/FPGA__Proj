...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Interface2 is
  ...
  signal \or_cond_reg_159[0]_i_5_n_0\ : STD_LOGIC;
  signal \or_cond_reg_159[0]_i_6_n_0\ : STD_LOGIC;
  ...
  signal \or_cond_reg_159_reg[0]_i_4_n_0\ : STD_LOGIC;
  signal \or_cond_reg_159_reg[0]_i_4_n_1\ : STD_LOGIC;
  signal \or_cond_reg_159_reg[0]_i_4_n_2\ : STD_LOGIC;
  signal \or_cond_reg_159_reg[0]_i_4_n_3\ : STD_LOGIC;
  signal tmp_4_fu_141_p2 : STD_LOGIC;
  signal \NLW_or_cond_reg_159_reg[0]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_or_cond_reg_159_reg[0]_i_2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of \XY_Green_V_preg[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \XY_Green_V_preg[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \XY_Green_V_preg[4]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \XY_Green_V_preg[5]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \XY_Green_V_preg[6]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \XY_Green_V_preg[7]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \XY_Red_V_preg[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \XY_Red_V_preg[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \XY_Red_V_preg[2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \XY_Red_V_preg[3]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \XY_Red_V_preg[4]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \XY_Red_V_preg[5]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \XY_Red_V_preg[6]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \XY_Red_V_preg[7]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \or_cond_reg_159[0]_i_1\ : label is "soft_lutpair0";
begin
...
\or_cond_reg_159[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2FFF2000"
    )
        port map (
...
\or_cond_reg_159[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\or_cond_reg_159[0]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
...
\or_cond_reg_159[0]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"41"
    )
        port map (
...
\or_cond_reg_159[0]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000001F"
    )
        port map (
...
\or_cond_reg_159[0]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"22B2"
    )
        port map (
...
\or_cond_reg_159_reg[0]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => \or_cond_reg_159_reg[0]_i_4_n_0\,
      CO(3 downto 1) => \NLW_or_cond_reg_159_reg[0]_i_2_CO_UNCONNECTED\(3 downto 1),
      CO(0) => tmp_4_fu_141_p2,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \or_cond_reg_159[0]_i_5_n_0\,
      O(3 downto 0) => \NLW_or_cond_reg_159_reg[0]_i_2_O_UNCONNECTED\(3 downto 0),
      S(3 downto 1) => B"000",
      S(0) => \or_cond_reg_159[0]_i_6_n_0\
    );
\or_cond_reg_159_reg[0]_i_4\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \or_cond_reg_159_reg[0]_i_4_n_0\,
      CO(2) => \or_cond_reg_159_reg[0]_i_4_n_1\,
      CO(1) => \or_cond_reg_159_reg[0]_i_4_n_2\,
      CO(0) => \or_cond_reg_159_reg[0]_i_4_n_3\,
      CYINIT => '0',
      DI(3) => \or_cond_reg_159[0]_i_8_n_0\,
      DI(2) => \or_cond_reg_159[0]_i_9_n_0\,
      DI(1) => \or_cond_reg_159[0]_i_10_n_0\,
      DI(0) => \or_cond_reg_159[0]_i_11_n_0\,
      O(3 downto 0) => \NLW_or_cond_reg_159_reg[0]_i_4_O_UNCONNECTED\(3 downto 0),
      S(3) => \or_cond_reg_159[0]_i_12_n_0\,
      S(2) => \or_cond_reg_159[0]_i_13_n_0\,
      S(1) => \or_cond_reg_159[0]_i_14_n_0\,
      S(0) => \or_cond_reg_159[0]_i_15_n_0\
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
