...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Interface2 is
  ...
  signal \XY_Blue_V[1]_INST_0_i_4_n_0\ : STD_LOGIC;
  signal \XY_Blue_V[1]_INST_0_i_5_n_0\ : STD_LOGIC;
  signal \^xy_red_v\ : STD_LOGIC_VECTOR ( 7 downto 2 );
  signal \^ap_start\ : STD_LOGIC;
  signal p_0_in : STD_LOGIC_VECTOR ( 0 to 0 );
  signal tmp_1_fu_111_p2 : STD_LOGIC;
  signal tmp_2_fu_160_p2 : STD_LOGIC;
  signal tmp_4_fu_166_p2 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \XY_Blue_V[1]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \XY_Blue_V[1]_INST_0_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \XY_Blue_V[1]_INST_0_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \XY_Blue_V[2]_INST_0\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \XY_Blue_V[4]_INST_0\ : label is "soft_lutpair2";
begin
...
\XY_Blue_V[1]_INST_0_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0057"
    )
        port map (
      ...
      I1 => y_V(4),
      I2 => y_V(3),
      I3 => \XY_Blue_V[1]_INST_0_i_4_n_0\,
      O => tmp_1_fu_111_p2
    );
\XY_Blue_V[1]_INST_0_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FEEEAAAA"
    )
        port map (
      I0 => x_V(9),
      I1 => x_V(7),
      I2 => \XY_Blue_V[1]_INST_0_i_5_n_0\,
      I3 => x_V(6),
      I4 => x_V(8),
      O => tmp_4_fu_166_p2
    );
\XY_Blue_V[1]_INST_0_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => y_V(9),
      I3 => y_V(8),
      O => \XY_Blue_V[1]_INST_0_i_4_n_0\
    );
\XY_Blue_V[1]_INST_0_i_5\: unisim.vcomponents.LUT6
    generic map(
