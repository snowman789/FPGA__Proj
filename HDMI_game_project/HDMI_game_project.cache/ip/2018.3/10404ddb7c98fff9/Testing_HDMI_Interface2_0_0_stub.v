...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst, ap_start, ap_done, ap_idle, 
  ap_ready, x_V, y_V, XY_Red_V, XY_Green_V, XY_Blue_V, lose, center_line_V, right_r)
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,x_V[9:0],y_V[9:0],XY_Red_V[7:0],XY_Green_V[7:0],XY_Blue_V[7:0],lose,center_line_V[9:0],right_r" */;
  input ap_clk;
  input ap_rst;
  input ap_start;
  output ap_done;
