...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Interface2 is
  ...
  signal tmp_4_fu_133_p2 : STD_LOGIC;
  signal tmp_4_reg_139 : STD_LOGIC;
  signal \tmp_4_reg_139[0]_i_10_n_0\ : STD_LOGIC;
  signal \tmp_4_reg_139[0]_i_11_n_0\ : STD_LOGIC;
  signal \tmp_4_reg_139[0]_i_12_n_0\ : STD_LOGIC;
  signal \tmp_4_reg_139[0]_i_13_n_0\ : STD_LOGIC;
  signal \tmp_4_reg_139[0]_i_1_n_0\ : STD_LOGIC;
  signal \tmp_4_reg_139[0]_i_4_n_0\ : STD_LOGIC;
  signal \tmp_4_reg_139[0]_i_5_n_0\ : STD_LOGIC;
  signal \tmp_4_reg_139[0]_i_6_n_0\ : STD_LOGIC;
  signal \tmp_4_reg_139[0]_i_7_n_0\ : STD_LOGIC;
  signal \tmp_4_reg_139[0]_i_8_n_0\ : STD_LOGIC;
  signal \tmp_4_reg_139[0]_i_9_n_0\ : STD_LOGIC;
  signal \tmp_4_reg_139_reg[0]_i_3_n_0\ : STD_LOGIC;
  signal \tmp_4_reg_139_reg[0]_i_3_n_1\ : STD_LOGIC;
  signal \tmp_4_reg_139_reg[0]_i_3_n_2\ : STD_LOGIC;
  signal \tmp_4_reg_139_reg[0]_i_3_n_3\ : STD_LOGIC;
  signal \NLW_tmp_4_reg_139_reg[0]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_tmp_4_reg_139_reg[0]_i_2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_tmp_4_reg_139_reg[0]_i_3_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \XY_Blue_V_preg[7]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \XY_Green_V_preg[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \XY_Green_V_preg[1]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \XY_Green_V_preg[6]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \XY_Green_V_preg[7]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \XY_Red_V_preg[0]_i_1\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \tmp_4_reg_139[0]_i_1\ : label is "soft_lutpair0";
begin
...
\tmp_4_reg_139[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BF80"
    )
        port map (
      ...
      I2 => ap_start,
      I3 => tmp_4_reg_139,
      O => \tmp_4_reg_139[0]_i_1_n_0\
    );
\tmp_4_reg_139[0]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      O => \tmp_4_reg_139[0]_i_10_n_0\
    );
\tmp_4_reg_139[0]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      O => \tmp_4_reg_139[0]_i_11_n_0\
    );
\tmp_4_reg_139[0]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      O => \tmp_4_reg_139[0]_i_12_n_0\
    );
\tmp_4_reg_139[0]_i_13\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      O => \tmp_4_reg_139[0]_i_13_n_0\
    );
\tmp_4_reg_139[0]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
      ...
      I1 => x_V(9),
      I2 => x_V(8),
      O => \tmp_4_reg_139[0]_i_4_n_0\
    );
\tmp_4_reg_139[0]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"41"
    )
        port map (
      ...
      O => \tmp_4_reg_139[0]_i_5_n_0\
    );
\tmp_4_reg_139[0]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"22B2"
    )
        port map (
      ...
      I3 => x_V(6),
      O => \tmp_4_reg_139[0]_i_6_n_0\
    );
\tmp_4_reg_139[0]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"22B2"
    )
        port map (
      ...
      I3 => x_V(4),
      O => \tmp_4_reg_139[0]_i_7_n_0\
    );
\tmp_4_reg_139[0]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"22B2"
    )
        port map (
      ...
      I3 => x_V(2),
      O => \tmp_4_reg_139[0]_i_8_n_0\
    );
\tmp_4_reg_139[0]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"22B2"
    )
        port map (
      ...
      I3 => x_V(0),
      O => \tmp_4_reg_139[0]_i_9_n_0\
    );
\tmp_4_reg_139_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => '1',
      D => \tmp_4_reg_139[0]_i_1_n_0\,
      Q => tmp_4_reg_139,
      R => '0'
    );
\tmp_4_reg_139_reg[0]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => \tmp_4_reg_139_reg[0]_i_3_n_0\,
      CO(3 downto 1) => \NLW_tmp_4_reg_139_reg[0]_i_2_CO_UNCONNECTED\(3 downto 1),
      CO(0) => tmp_4_fu_133_p2,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \tmp_4_reg_139[0]_i_4_n_0\,
      O(3 downto 0) => \NLW_tmp_4_reg_139_reg[0]_i_2_O_UNCONNECTED\(3 downto 0),
      S(3 downto 1) => B"000",
      S(0) => \tmp_4_reg_139[0]_i_5_n_0\
    );
\tmp_4_reg_139_reg[0]_i_3\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \tmp_4_reg_139_reg[0]_i_3_n_0\,
      CO(2) => \tmp_4_reg_139_reg[0]_i_3_n_1\,
      CO(1) => \tmp_4_reg_139_reg[0]_i_3_n_2\,
      CO(0) => \tmp_4_reg_139_reg[0]_i_3_n_3\,
      CYINIT => '0',
      DI(3) => \tmp_4_reg_139[0]_i_6_n_0\,
      DI(2) => \tmp_4_reg_139[0]_i_7_n_0\,
      DI(1) => \tmp_4_reg_139[0]_i_8_n_0\,
      DI(0) => \tmp_4_reg_139[0]_i_9_n_0\,
      O(3 downto 0) => \NLW_tmp_4_reg_139_reg[0]_i_3_O_UNCONNECTED\(3 downto 0),
      S(3) => \tmp_4_reg_139[0]_i_10_n_0\,
      S(2) => \tmp_4_reg_139[0]_i_11_n_0\,
      S(1) => \tmp_4_reg_139[0]_i_12_n_0\,
      S(0) => \tmp_4_reg_139[0]_i_13_n_0\
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
