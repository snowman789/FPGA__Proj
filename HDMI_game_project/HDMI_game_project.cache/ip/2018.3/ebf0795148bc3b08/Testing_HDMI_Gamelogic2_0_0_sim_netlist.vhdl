...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Gamelogic2 is
  ...
  signal \time_remaining_out_V[9]_INST_0_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \time_remaining_out_V[0]_INST_0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \time_remaining_out_V[2]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \time_remaining_out_V[3]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \time_remaining_out_V[6]_INST_0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \time_remaining_out_V[8]_INST_0\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \time_remaining_out_V[9]_INST_0_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \time_remaining_out_V[9]_INST_0_i_2\ : label is "soft_lutpair1";
...
\time_remaining_out_V[0]_INST_0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\time_remaining_out_V[1]_INST_0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\time_remaining_out_V[2]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8008"
    )
        port map (
...
\time_remaining_out_V[6]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8008"
    )
        port map (
...
\time_remaining_out_V[9]_INST_0_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF80"
    )
        port map (
...
\time_remaining_out_V[9]_INST_0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
