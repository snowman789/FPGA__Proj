...
Game_logic_urem_3cud #(
    .ID( 1 ),
    .NUM_STAGE( 36 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 8 ),
    .dout_WIDTH( 11 ))
Game_logic_urem_3cud_U2(
    .clk(ap_clk),
    .reset(ap_rst),
...
Game_logic_urem_1dEe #(
    .ID( 1 ),
    .NUM_STAGE( 15 ),
    .din0_WIDTH( 11 ),
    .din1_WIDTH( 8 ),
    .dout_WIDTH( 11 ))
Game_logic_urem_1dEe_U3(
    .clk(ap_clk),
    .reset(ap_rst),
