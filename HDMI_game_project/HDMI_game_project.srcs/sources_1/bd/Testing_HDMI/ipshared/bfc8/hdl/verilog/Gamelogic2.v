...
reg   [0:0] brmerge1_reg_603;
wire   [31:0] btn_count_loc_fu_278_p3;
reg   [31:0] btn_count_loc_reg_609;
wire   [0:0] game_over_load_load_fu_286_p1;
reg   [0:0] game_over_load_reg_616;
wire   [13:0] new_center_8_fu_484_p3;
reg   [13:0] new_center_8_reg_620;
wire   [0:0] tmp_1_fu_492_p2;
reg   [0:0] tmp_1_reg_626;
...
wire   [0:0] brmerge12_demorgan_fu_539_p2;
wire   [0:0] tmp_i_fu_550_p2;
wire   [0:0] tmp_1_i_fu_555_p2;
...
wire   [0:0] brmerge12_demorgan_fu_539_p1;
wire   [0:0] tmp_3_fu_566_p3;
wire   [11:0] tmp_4_fu_574_p1;
...
always @ (posedge ap_clk) begin
    if (((tmp_1_fu_492_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        btn_count_flag_2_reg_160 <= brmerge1_reg_603;
    end else if (((tmp_1_reg_626 == 1'd1) & (game_over_load_reg_616 == 1'd0) & (1'b1 == ap_CS_fsm_state38))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_1_fu_492_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        btn_count_new_2_reg_172 <= btn_count_loc_reg_609;
    end else if (((tmp_1_reg_626 == 1'd1) & (game_over_load_reg_616 == 1'd0) & (1'b1 == ap_CS_fsm_state38))) begin
...
always @ (posedge ap_clk) begin
    if ((((tmp_1_reg_626 == 1'd1) & (game_over_load_reg_616 == 1'd0) & (1'b1 == ap_CS_fsm_state38)) | ((tmp_1_fu_492_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
        new_center_9_reg_184 <= new_center_8_reg_620;
    end else if (((game_over_load_load_fu_286_p1 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_1_reg_626 == 1'd1) & (game_over_load_reg_616 == 1'd0) & (1'b1 == ap_CS_fsm_state38))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        brmerge1_reg_603 <= brmerge1_fu_262_p2;
        btn_count_loc_reg_609 <= btn_count_loc_fu_278_p3;
        game_over_load_reg_616 <= game_over;
    end
end
...
always @ (posedge ap_clk) begin
    if (((brmerge12_demorgan_fu_539_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state38))) begin
        first_run <= 1'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((((tmp_1_i_fu_555_p2 == 1'd1) & (tmp_i_fu_550_p2 == 1'd0) & (brmerge12_demorgan_fu_539_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state38)) | ((tmp_i_fu_550_p2 == 1'd1) & (brmerge12_demorgan_fu_539_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state38)))) begin
        game_over <= 1'd1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((game_over_load_load_fu_286_p1 == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        new_center_8_reg_620 <= new_center_8_fu_484_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        tmp_1_reg_626 <= tmp_1_fu_492_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_1_fu_492_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_i_i_reg_630 <= tmp_i_i_fu_501_p2;
    end
end
...
always @ (*) begin
    if (((tmp_1_i_fu_555_p2 == 1'd0) & (tmp_i_fu_550_p2 == 1'd0) & (brmerge12_demorgan_fu_539_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state38))) begin
        ap_phi_mux_end_game_write_assig_phi_fu_213_p6 = 1'd0;
    end else if ((((tmp_1_i_fu_555_p2 == 1'd1) & (tmp_i_fu_550_p2 == 1'd0) & (brmerge12_demorgan_fu_539_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state38)) | ((tmp_i_fu_550_p2 == 1'd1) & (brmerge12_demorgan_fu_539_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state38)))) begin
...
always @ (*) begin
    if (((tmp_1_reg_626 == 1'd1) & (game_over_load_reg_616 == 1'd0) & (1'b1 == ap_CS_fsm_state38))) begin
        ap_phi_mux_new_center_9_phi_fu_187_p6 = new_center_8_reg_620;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state38)) begin
        if ((brmerge12_demorgan_fu_539_p2 == 1'd0)) begin
            ap_phi_mux_new_center_s_phi_fu_228_p4 = ap_phi_mux_new_center_9_phi_fu_187_p6;
        end else if ((brmerge12_demorgan_fu_539_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((((tmp_1_i_fu_555_p2 == 1'd0) & (tmp_i_fu_550_p2 == 1'd0) & (brmerge12_demorgan_fu_539_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state38)) | ((tmp_1_i_fu_555_p2 == 1'd1) & (tmp_i_fu_550_p2 == 1'd0) & (brmerge12_demorgan_fu_539_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state38)))) begin
        ap_phi_mux_right_wins_write_ass_phi_fu_198_p6 = 1'd0;
    end else if (((tmp_i_fu_550_p2 == 1'd1) & (brmerge12_demorgan_fu_539_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state38))) begin
...
always @ (*) begin
    if (((brmerge12_demorgan_fu_539_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state38))) begin
...
assign brmerge12_demorgan_fu_539_p1 = reset_game_in;

assign brmerge12_demorgan_fu_539_p2 = (first_run & brmerge12_demorgan_fu_539_p1);
...
assign center_line_out_V = ((tmp_3_fu_566_p3[0:0] === 1'b1) ? 12'd0 : tmp_4_fu_574_p1);

assign end_game = ap_phi_mux_end_game_write_assig_phi_fu_213_p6;

assign game_over_load_load_fu_286_p1 = game_over;

assign grp_fu_512_p0 = (32'd100 + tmp_i_i_reg_630);
...
assign tmp_1_fu_492_p2 = (($signed(btn_count_loc_reg_609) > $signed(32'd10)) ? 1'b1 : 1'b0);

assign tmp_1_i_fu_555_p2 = ((center_line_in_V > 12'd639) ? 1'b1 : 1'b0);

assign tmp_2_fu_518_p1 = grp_fu_512_p2[6:0];

assign tmp_3_fu_566_p3 = ap_phi_mux_new_center_s_phi_fu_228_p4[32'd13];

assign tmp_4_fu_574_p1 = ap_phi_mux_new_center_s_phi_fu_228_p4[11:0];
...
assign tmp_i_fu_550_p2 = ((center_line_in_V == 12'd0) ? 1'b1 : 1'b0);
