...
module Testing_HDMI_Interface2_0_0(ap_clk, ap_rst, ap_start, ap_done, ap_idle, 
  ap_ready, x_V, y_V, XY_Red_V, XY_Green_V, XY_Blue_V, center_line_V, right_r)
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,x_V[9:0],y_V[9:0],XY_Red_V[7:0],XY_Green_V[7:0],XY_Blue_V[7:0],center_line_V[11:0],right_r" */;
  input ap_clk;
  input ap_rst;
  input ap_start;
  output ap_done;
