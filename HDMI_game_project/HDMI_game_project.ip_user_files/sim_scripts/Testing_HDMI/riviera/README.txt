...
#
# Generated by export_simulation on Sun Apr 21 18:10:02 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './Testing_HDMI.sh' script.

./Testing_HDMI.sh -reset_run
...
./Testing_HDMI.sh -noclean_files

For more information on the script, please type './Testing_HDMI.sh -help'.
